...
### [Part-3 Server programming with NodeJSs Express library](./Part-3-Server-programming-with-NodeJSs-Express-library/)
- **[3.1 Phonebook Backend](./Part-3-Server-programming-with-NodeJSs-Express-library/3.1-phonebook-backend/index.js)**
- **[3.9 Phonebook Fullstack](./Part-3-Server-programming-with-NodeJSs-Express-library/3.9-phone-book-fullstack/frontend/src/App.jsx)**
- **[3.12 Database CLI](./Part-3-Server-programming-with-NodeJSs-Express-library/3.12-database-CLI/index.js)**

### [Part-4 Express application testing user management](./Part-4-Express-application-testing-user-management/)
